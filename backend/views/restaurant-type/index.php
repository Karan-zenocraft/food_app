...
/* @var $searchModel common\models\RestaurantTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Restaurant Types';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="restaurant-type-index email-format-index">
    ...
    <div class="navbar navbar-inner block-header">
     ...
     <?php if (!empty($_REQUEST['RestaurantsSearch']) || (!empty($_GET['temp']) && $_GET['temp'] == "clear")) {?>
        <div class="restaurant-types-serach common_search">
         <?php echo $this->render('_search', ['model' => $searchModel]); ?>
        </div>
<?php } else {?>
    <div class="restaurant-type-serach common_search">
         <?php echo $this->render('_search', ['model' => $searchModel]); ?>
        </div>
    <?php }?>
</div>
...
if ($user_role == Yii::$app->params['userroles']['super_admin']) {?>
        ...
        <?=Html::a(Yii::t('app', '<i class="icon-plus"></i> Add Restaurant Type'), ['create'], ['class' => 'btn btn-success'])?>
       </div>
<?php }
?>
    </div>
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => function ($url, $model) {
                    $flag = 1;
                    $confirmmessage = "Are you sure you want to delete this Restaurant Type?";
...
$( document ).ready(function() {
    $('.restaurant-type-serach').hide();
        $('.open_search').click(function(){
            $('.restaurant-type-serach').toggle();
        });
    });
</script>